                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    {{ csrf_field() }}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" name="no_hp" required="required" placeholder="No.HP">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Alamat</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" name="alamat" required="required" placeholder="Alamat"></textarea>
                        </div>
                      </div>
                      </div>
                      </div>
